...
class SetActivityActionUnknownParamCommand: public SetUnknownPropertyCommand
{
  public:
    SetActivityActionUnknownParamCommand(ConfigData &c,
        const data::item::UnknownElement &value, uint32_t activityPos,
