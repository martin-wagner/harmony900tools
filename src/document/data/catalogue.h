...
class CmdCatalogue : public QObject
{
  ...
  public:
    ...
    bool addStateCommand(uint32_t devicePos, uint32_t smPos, item::StateTransitionType t, const QString &name, int actPos);
    bool addActionCommand(uint32_t devicePos, uint32_t smPos, item::StateTransitionAction t);
    bool removeStateCommand(uint32_t devicePos, uint32_t smPos, item::StateTransitionType t, int actPos);
    bool removeActionCommand(uint32_t devicePos, uint32_t smPos, item::StateTransitionAction t);
    bool setActionType(const Enum<ActionType> &v, uint32_t devicePos, uint32_t smPos, item::StateTransitionAction t, uint32_t actPos);
    bool setActionRepeatWillNotHarm(bool v, uint32_t devicePos, uint32_t smPos, item::StateTransitionAction t, uint32_t actPos);
