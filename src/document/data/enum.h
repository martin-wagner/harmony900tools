...
enum class StateMachineDeviceType { Power, Input, Screen, TVInput, AntennaOutput, User1, User2, User3, User4, User5, Unknown };
...
//non-remote enums
enum class CodeType { NEC, KASEIKYO, SIRCS12, SIRCS15, SIRCS20, Samsung32, PhilipsRC5, PhilipsRC6, PhilipsRC6A, None, Proprietary, Unknown };
